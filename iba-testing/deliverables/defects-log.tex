...
DEF-010 & TC-BOOK-010 & S1 & Missing Range Validation on \texttt{slot\_id} crashes Database & Open \\
...
DEF-015 & TC-DATA-001 & S2 & API SELECT explicitly omits \texttt{reviewed\_by} field & Open \\
\end{longtable}
\end{center}
...
% ================= PAGE 1 =================
\defectheader{DEF-001}{Cancelled bookings are incorrectly marked as 'rejected'}{TC-CANCEL-001/002/005}{S2 (Major)}{Open}
...
\defectheader{DEF-002}{Unconditional DB unique constraint prevents slot recycling}{TC-BOOK-BUG / TC-CANCEL-BUG}{S1 (Critical)}{Open}
\begin{itemize}[noitemsep,topsep=1pt,leftmargin=0.5cm]
    \item \textbf{Steps to Reproduce:} 
...
% ================= PAGE 2 =================
\defectheader{DEF-003}{Missing validation checks allow room bookings for past dates}{TC-BOOK-PAST}{S2 (Major)}{Open}
\begin{itemize}[noitemsep,topsep=1pt,leftmargin=0.5cm]
    \item \textbf{Steps to Reproduce:} 
...
\defectheader{DEF-004}{Approved bookings on student dashboard lack Cancel option}{TC-CANCEL-002}{S2 (Major)}{Open}
\begin{itemize}[noitemsep,topsep=1pt,leftmargin=0.5cm]
    \item \textbf{Steps to Reproduce:} 
...
% ================= PAGE 4 =================
\defectheader{DEF-007}{Lack of temporal check allows cancellation of elapsed bookings}{TC-CANCEL-004}{S2 (Major)}{Open}
\begin{itemize}[noitemsep,topsep=1pt,leftmargin=0.5cm]
    \item \textbf{Steps to Reproduce:} 
...
\defectheader{DEF-010}{Missing range validation on slot ID crashes the database}{TC-BOOK-010}{S1 (Critical)}{Open}
\begin{itemize}[noitemsep,topsep=1pt,leftmargin=0.5cm]
    \item \textbf{Steps to Reproduce:} 
...
% ================= PAGE 8 =================
\defectheader{DEF-015}{API SELECT statements explicitly omit reviewer ID field}{TC-DATA-001}{S2 (Major)}{Open}
\begin{itemize}[noitemsep,topsep=1pt,leftmargin=0.5cm]
    \item \textbf{Steps to Reproduce:} 
